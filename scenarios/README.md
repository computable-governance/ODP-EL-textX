...
| `terms_of_engagement/external_agent_access_scenario.el` | Probe | v2 | 2026-09-25 (single commit) | Tier-1 terms of engagement for external AI agents (unilateral contract community; security, normative and deontic policies side by side). Dead-ended at 4 worlds until AM-99a part 2 (Rule T11 fires action-emitted triggers in the static verifier); now 2444 worlds, EF true for all three burdens (`tests/test_am99a_t11_event_firing.py`). Candidate for promotion to Demo once AM-99a part 3 (bounded response property) lands. |
