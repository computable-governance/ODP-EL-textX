...
*Last updated: 2026-09-26, alongside AM-109 (violated worlds are no longer
terminal; AM-105's exception retired). Previously updated the same day,
alongside AM-108 (T2 only for deadlines with
